			...
			<div id="wrapper">
				...
				<!-- Intro -->
					<section class="intro">
						...
						<div class="content">
							<span class="image fill" data-position="center"><img src="images/profile.jpg" alt="" /></span>
						</div>
					</section>
							...
							<ul class="items">
								...
								<li> 
									...
									<ul class="icons">
										...
										<li><a href="https://github.com/readyjune" class="icon brands fa-github"><span class="label">GitHub</span></a></li>
										<li><a href="https://www.youtube.com/channel/UCR1B_4dX-Px68KLR5-aGVmQ" class="icon brands fa-youtube"><span class="label">YouTube</span></a></li>
									</ul>
								</li>
							</ul>
						</footer>
